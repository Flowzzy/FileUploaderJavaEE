        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-list-alt"></i></h3>
                            <ol class="breadcrumb">

                                <li><i class="fa fa-desktop"></i>Upload</li>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    File type  : ${requestScope["type"]}<br>
                                    <hr>
                                    <a href="/UploadFicheiros" ><button type="submit" class="btn btn-primary">Voltar</button></a>
                            ...
                            <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> <!--/.by Edon--> 